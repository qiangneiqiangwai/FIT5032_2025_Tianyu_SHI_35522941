...
const hasFriendInReason = computed(() => {
  return formData.value.reason && formData.value.reason.toLowerCase().includes('friend')
})
      ...
      <div class="col-md-8 offset-md-2">
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="mb-3">
            ...
            ></textarea>
            <div v-if="hasFriendInReason" class="text-success mt-1">Great to have a friend</div>
          </div>
